                    ...
                    <div class="card-body">
                        <form class="form" method="post" action="{{ route('user.update') }}">
                            ...
                            <div class="mb-3 text-start">
                                ...
                                <input type="number" placeholder = "Ex. {{ $PrecinctID }}" class="form-control" name="vote" id="vote" required>

                                <label for="exampleInputEmail1" class="form-label h5">Ilan ang Invalid votes?</label>
                                <input type="number"  placeholder = "Ex. {{ $PrecinctID }}"  class="form-control" name="Invalidvote" id="Invalidvote" required>
                            </div>
